<form class="row gy-1 pt-75" action="{{Route('customer.ajax.addCustomer')}}" method="post">
    ...
    <div class="col-12 col-md-12">
        ...
        <input type="text" class="form-control domain_name required" name="domain_name" value="{{$customer->domain_name}}">
        @error('domain_name')
    ...
    <div class="col-6 col-md-6">
        ...
        <input type="text" class="form-control required flatpickr-basic start_date" name="start_date" value="{{$customer->start_date}}">
        @error('start_date')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-6 col-md-6">
        ...
        <input type="number" class="form-control cost required" name="cost" value="{{$customer->cost}}">
        @error('cost')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-6 col-md-6">
        ...
        <input type="text" name="comment" class="form-control comment" id="" value="{{$customer->comment}}">
        @error('comment')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class=" col-6 col-md-6">
        ...
        <div class="d-flex col-md-6" style="margin-left: 1rem;">
            <div class="col-md-12">
                <input type="radio" name="hosted" id="internal" class="form-check-input hosted" value="internal" {{($customer->hosted == "internal") ? "checked": ""}}>
                <label for="internal" style="margin-left: 30px;">Internal</label>
            </div>
            <div class="col-md-12">
                <input type="radio" name="hosted" id="external" class="form-check-input hosted" value="external" {{($customer->hosted == "external") ? "checked": ""}}>
    ...
    <div class="col-12 col-md-12">
        <div class="form-check form-check-inline service_check">
            ...
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" {{($customer->service_stopped == true) ? "checked" : ""}} />
    ...
    <div class="col-6 col-md-6 service {{($customer->service_stopped == true) ?  : 'hidden' }}">
        ...
        <input type="text" class="form-control stopped_by required" name="stopped_by" value="{{$customer->stopped_by??''}}">
        @error('stopped_by')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-6 col-md-6 service {{($customer->service_stopped == true) ?  : 'hidden' }}">
        ...
        <input type="text" class="form-control stopped_comment required" name="stopped_comment" value="{{$customer->stopped_comment??''}}">
